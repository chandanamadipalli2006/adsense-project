...
export default function EighthHindiTeachingNotes() {
      ...
      items: [
        {
          ...
          description: "Foundation teaching methodologies with examples",
        },
        {
          title: "CHAPTER 2",
          icon: NotebookPen,
          color: "bg-purple-600 hover:bg-purple-700",
          description: "Interactive classroom strategies and activities",
        },
        {
          title: "CHAPTER 3",
          icon: NotebookPen,
          color: "bg-purple-600 hover:bg-purple-700",
          description: "Effective grammar instruction techniques",
        },
        {
          title: "CHAPTER 4",
          icon: NotebookPen,
          color: "bg-purple-600 hover:bg-purple-700",
          description: "Reading comprehension teaching approaches",
        },
        {
          title: "CHAPTER 5",
          icon: NotebookPen,
          color: "bg-purple-600 hover:bg-purple-700",
          description: "Writing skills development strategies",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          description: "Literature teaching methodologies",
        },
        {
          title: "CHAPTER 7",
          icon: NotebookPen,
          color: "bg-indigo-600 hover:bg-indigo-700",
          description: "Critical thinking development approaches",
        },
        {
          title: "CHAPTER 8",
          icon: NotebookPen,
          color: "bg-indigo-600 hover:bg-indigo-700",
          description: "Poetry teaching techniques and activities",
        },
        {
          title: "CHAPTER 9",
          icon: NotebookPen,
          color: "bg-indigo-600 hover:bg-indigo-700",
          description: "Assessment and feedback strategies",
        },
        {
          title: "CHAPTER 10",
          icon: NotebookPen,
          color: "bg-indigo-600 hover:bg-indigo-700",
          description: "Revision and reinforcement teaching methods",
        },
      ],
    },
  ]
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
              Class 8 <span className="text-purple-600">Hindi Teaching Notes</span>
            </h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Quarterly Teaching Resources */}
            <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl p-8 mb-8">
              <h3 className="text-2xl font-bold text-gray-900 text-center mb-6">Quarterly Teaching Resources</h3>
