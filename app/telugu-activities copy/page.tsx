...
export default function TeluguActivities() {
  const activityLinks = [
    "https://wordwall.net/resource/81682024", // Activity 1
    "https://wordwall.net/resource/81680493", // Activity 2
    "", "", "", "", // Placeholder for 3-6
  ]
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-gray-900 text-center mb-8">More Telugu Activities</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              {[1, 2, 3, 4, 5, 6].map((index) => (
                ...
                >
                  ...
                  <p className="text-gray-600 mb-4">Interactive Telugu learning activity for better understanding</p>
                  ...
                  {activityLinks[index - 1] ? (
                    <a
                      ...
                      className="block"
                    >
                      <Button className="w-full bg-purple-600 hover:bg-purple-700 text-white">Start Activity</Button>
                    </a>
                  ) : (
