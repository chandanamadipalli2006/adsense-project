...
import { ArrowLeft, FileText, BookOpen, PenTool, Puzzle, MessageSquare } from "lucide-react"
...
export default function SixthHindiActivities() {
  const activities = [
    {
      title: "शब्द निर्माण (Word Formation)",
      description: "Create words from given letters and improve vocabulary",
      icon: FileText,
      color: "bg-blue-500",
      hoverColor: "hover:bg-blue-600",
    },
    {
      title: "वाक्य रचना (Sentence Formation)",
      description: "Practice creating grammatically correct sentences",
      icon: PenTool,
      color: "bg-green-500",
      hoverColor: "hover:bg-green-600",
    },
    {
      title: "कहानी पूरी करें (Complete the Story)",
      description: "Complete stories with appropriate words and phrases",
      icon: BookOpen,
      color: "bg-purple-500",
      hoverColor: "hover:bg-purple-600",
    },
    {
      title: "शब्द पहेली (Word Puzzle)",
      description: "Solve Hindi word puzzles to enhance language skills",
      icon: Puzzle,
      color: "bg-orange-500",
    ...
    },
    {
      ...
      description: "Practice writing conversations between characters",
      icon: MessageSquare,
      color: "bg-red-500",
      hoverColor: "hover:bg-red-600",
    },
    {
      title: "चित्र वर्णन (Picture Description)",
      description: "Describe pictures in Hindi to improve writing skills",
      icon: FileText,
      color: "bg-teal-500",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
              Class 6 <span className="text-emerald-600">Hindi Activities</span>
            </h1>
