...
export default function SixthHindi() {
  const resources = [
    {
      name: "Lesson Plans",
      icon: BookOpen,
      ...
      description: "Detailed lesson plans for 6th class Hindi curriculum",
      link: "/6th-hindi-lesson-plans",
    },
    {
      ...
      link: "/6th-hindi-study-materials",
    },
    {
      name: "Teaching Notes",
      icon: NotebookPen,
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
              Class 6 <span className="text-emerald-600">Hindi Resources</span>
            </h1>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Access comprehensive teaching and learning materials for Class 6 Hindi
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-cyan-50 to-blue-50 rounded-2xl p-8 mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <Button className="bg-cyan-600 hover:bg-cyan-700 text-white py-3">
