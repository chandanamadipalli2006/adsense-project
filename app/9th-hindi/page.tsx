        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
              Class 9 <span className="text-emerald-600">Hindi Resources</span>
            </h1>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Access comprehensive teaching and learning materials for Class 9 Hindi
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 mb-8">
              <h3 className="text-2xl font-bold text-gray-900 text-center mb-6">Monthly Lesson Plans</h3>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                {[
                  ...
                  <Button key={month} className="bg-indigo-600 hover:bg-indigo-700 text-white py-3">
                    {month}
                  </Button>
                ))}
              </div>
