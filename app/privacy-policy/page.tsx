    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="prose prose-emerald max-w-none">
          ...
          <ul className="list-disc pl-6 space-y-2 mt-4">
            ...
            <li>
              <p>
                ...
                or &quot;Our&quot; in this Agreement) refers to greenera06.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to greenera06, accessible from{" "}
                <a
                  href="https://greenera06.com"
                  rel="noreferrer external nofollow noopener"
                  target="_blank"
                  className="text-emerald-600 hover:text-emerald-700"
                >
                  https://greenera06.com
                </a>
              </p>
            </li>
            <li>
          ...
          <h4 className="text-lg font-semibold text-gray-900 mt-5 mb-2">Personal Data</h4>
          <p>
          ...
          <h4 className="text-lg font-semibold text-gray-900 mt-5 mb-2">Usage Data</h4>
          ...
          <h4 className="text-lg font-semibold text-gray-900 mt-5 mb-2">Tracking Technologies and Cookies</h4>
          <p>
          ...
          <h4 className="text-lg font-semibold text-gray-900 mt-5 mb-2">Business Transactions</h4>
          <p>
          ...
          <h4 className="text-lg font-semibold text-gray-900 mt-5 mb-2">Law enforcement</h4>
          <p>
          ...
          <h4 className="text-lg font-semibold text-gray-900 mt-5 mb-2">Other legal requirements</h4>
