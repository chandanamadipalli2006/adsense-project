...
export default function TenthBiologyActivities() {
    const activities = [
        {
            name: "BIOLOGY MODEL ACTIVITY",
            link: "https://wordwall.net/resource/110236620",
            ...
            <section className="relative bg-gradient-to-br from-green-50 to-emerald-50 py-16 sm:py-24">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
                        10th Class <span className="text-green-600">Biology Activities</span>
                    </h1>
                    <p className="text-xl text-gray-600">
                        Explore life science with fun interactive activities 🌿
                    </p>
                </div>
            </section>
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="text-center mb-12">
                            <h2 className="text-3xl font-bold text-gray-900 mb-4">
                                Play Biology Activities
                            </h2>
                            <p className="text-gray-600 text-lg">
                                Click and explore engaging biology activities
                            </p>
                        </div>
