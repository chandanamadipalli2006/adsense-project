...
export default function NinthHindiDiaries() {
      ...
      items: [
        {
          ...
          description: "Focused planning for exam preparation period",
        },
        {
          title: "REVISION SCHEDULE",
          icon: BookMarked,
          color: "bg-red-600 hover:bg-red-700",
          description: "Structured revision planning for key topics",
        },
        {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
              Class 9 <span className="text-orange-600">Hindi Diaries</span>
            </h1>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-8 mb-8">
              <h3 className="text-2xl font-bold text-gray-900 text-center mb-6">Planning Tools</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <Button className="bg-amber-600 hover:bg-amber-700 text-white py-4">
