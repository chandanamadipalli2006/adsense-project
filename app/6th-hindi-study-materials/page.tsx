...
import { ArrowLeft, FileText, BookOpen, Download, Eye, PenTool, Lightbulb } from "lucide-react"
import { Button } from "@/components/ui/button"
import { Card, CardContent } from "@/components/ui/card"

export default function SixthHindiStudyMaterials() {
      ...
      items: [
        {
          ...
          description: "Basic concepts with simple explanations",
        },
        {
          title: "LESSON 2",
          icon: BookOpen,
          color: "bg-green-600 hover:bg-green-700",
          description: "Interactive learning for beginners",
        },
        {
          title: "LESSON 3",
          icon: BookOpen,
        ...
        },
        {
          ...
          icon: BookOpen,
          color: "bg-green-600 hover:bg-green-700",
          description: "Building vocabulary and skills",
        },
        {
          title: "LESSON 5",
          icon: BookOpen,
          color: "bg-green-600 hover:bg-green-700",
          description: "Foundation strengthening materials",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          description: "Reading and comprehension skills",
        },
        {
          title: "LESSON 7",
          icon: BookOpen,
          color: "bg-blue-600 hover:bg-blue-700",
          description: "Writing and expression development",
        },
        {
          title: "LESSON 8",
          icon: BookOpen,
          color: "bg-blue-600 hover:bg-blue-700",
          description: "Creative thinking activities",
        },
        {
          title: "LESSON 9",
          icon: BookOpen,
          color: "bg-blue-600 hover:bg-blue-700",
          description: "Language skill enhancement",
        },
        {
          title: "LESSON 10-1",
          icon: BookOpen,
          color: "bg-purple-600 hover:bg-purple-700",
          description: "Advanced foundation concepts",
        },
      ],
    },
  ]
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
              Class 6 <span className="text-emerald-600">Hindi Study Materials</span>
            </h1>
            <p className="text-xl sm:text-2xl text-gray-600 font-medium mb-8">
              Foundation learning with engaging study resources
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-cyan-50 to-blue-50 rounded-2xl p-8 mb-8">
              <h3 className="text-2xl font-bold text-gray-900 text-center mb-6">Foundation Learning Materials</h3>
