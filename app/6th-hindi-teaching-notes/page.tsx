...
export default function SixthHindiTeachingNotes() {
  // Define teaching notes with icons and colors
  const teachingNotes = [
    {
      name: "Foundation Teaching Notes",
      items: [
        {
          title: "CHAPTER 1",
          icon: NotebookPen,
          color: "bg-purple-600 hover:bg-purple-700",
          description: "Basic Hindi teaching methodologies for beginners",
        },
        {
          title: "CHAPTER 2",
          icon: NotebookPen,
          color: "bg-purple-600 hover:bg-purple-700",
          description: "Interactive classroom activities for young learners",
        },
        {
          title: "CHAPTER 3",
          icon: NotebookPen,
          color: "bg-purple-600 hover:bg-purple-700",
          description: "Fundamental grammar instruction techniques",
        },
        {
          title: "CHAPTER 4",
          icon: NotebookPen,
          color: "bg-purple-600 hover:bg-purple-700",
          description: "Reading development teaching strategies",
        },
        {
          title: "CHAPTER 5",
          icon: NotebookPen,
          color: "bg-purple-600 hover:bg-purple-700",
          description: "Basic writing skills teaching approaches",
        },
      ],
    },
    {
      name: "Skill Development Teaching Notes",
      items: [
        {
          title: "CHAPTER 6",
          icon: NotebookPen,
          color: "bg-indigo-600 hover:bg-indigo-700",
          description: "Vocabulary building teaching methods",
        },
        {
          title: "CHAPTER 7",
          icon: NotebookPen,
          color: "bg-indigo-600 hover:bg-indigo-700",
          description: "Simple literature teaching approaches",
        },
        {
          title: "CHAPTER 8",
          icon: NotebookPen,
          color: "bg-indigo-600 hover:bg-indigo-700",
          description: "Creative expression teaching techniques",
        },
        {
          title: "CHAPTER 9",
          icon: NotebookPen,
          color: "bg-indigo-600 hover:bg-indigo-700",
          description: "Basic assessment and feedback methods",
        },
        {
          title: "CHAPTER 10",
          icon: NotebookPen,
          color: "bg-indigo-600 hover:bg-indigo-700",
          description: "Revision and reinforcement strategies",
        },
      ],
    },
  ]
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
              Class 6 <span className="text-purple-600">Hindi Teaching Notes</span>
            </h1>
            <p className="text-xl sm:text-2xl text-gray-600 font-medium mb-8">
              Foundation teaching strategies for beginning Hindi instruction
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Foundation Teaching Resources */}
            <div className="bg-gradient-to-r from-cyan-50 to-blue-50 rounded-2xl p-8 mb-8">
              <h3 className="text-2xl font-bold text-gray-900 text-center mb-6">Foundation Teaching Resources</h3>
