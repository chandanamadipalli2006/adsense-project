      ...
      <section className="bg-gradient-to-br from-red-50 to-orange-50 py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold mb-4">
            Class 9 <span className="text-red-600">Assignment Papers</span>
          </h1>
          <p className="text-xl text-gray-600">
            7th Class Hindi Assignments
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card className="hover:shadow-lg border-2 transition duration-300">
              <CardContent className="p-6">
                ...
                <div className="flex gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg">
                      जो देखकर भी नहीं देख सकते
                    </h3>
                    <p className="text-sm text-gray-500">
                      BALARAM 8th Hindi Assignment (2025-26)
                    </p>
                  </div>
                </div>
                ...
                {/* View Button */}
                <Link
                  href="/pdfs/BALARAM-8-ASSIGNMENT-जो देखकर भी नहीं देख सकते- 2025-26.pdf"
                  target="_blank"
                >
